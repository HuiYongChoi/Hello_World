...
4. **청약 축** — 미구현. 매수/전세/월세와 구조가 다릅니다: 계약금 10% → 중도금 60%
   (이자후불) → 잔금 30% 를 2~3년에 걸쳐 내고 그동안은 임차로 삽니다. tenure 엔진에
   납입 일정과 입주 시차를 넣어야 4번째 갈래가 됩니다. 단지별 **분양가·입주예정·
   중도금 조건·전매제한·가점**이 입력으로 필요합니다.
